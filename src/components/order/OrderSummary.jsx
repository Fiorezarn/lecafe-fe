...
export function OrderSummary() {
  ...
  return (
    <aside
      className={`md:w-1/3 ${
        orderType === "Delivery" ? "h-[85vh]" : "h-[80vh]"
      } overflow-y-auto bg-brown-900 p-6 text-white rounded-lg shadow-lg md:sticky md:top-8 bg-earth2 ${
    ...
    >
      ...
      <div className="mt-6">
        ...
        <div className="flex justify-between font-bold text-lg my-4">
          ...
          <span>{orderType === "Dine-in" ? "Free" : "N/A"}</span>
        </div>
